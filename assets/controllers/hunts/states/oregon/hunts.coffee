APP = window.APP
APP.Controllers.controller('HuntsOregonHunts', ['$scope', '$location', '$routeParams', '$sce', 'Hunt', 'HuntChoice', 'HuntOption', 'Storage', ($scope, $location, $routeParams, $sce, Hunt, HuntChoice, HuntOption, Storage) ->
  $scope.choice = {}
  $scope.hunts = {}
  $scope.types = {}
  $scope.huntType = ""
